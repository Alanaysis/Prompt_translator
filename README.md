...
| 领域 | 说明 | 术语数 |
|------|------|--------|
| [软件工程](./domains/software-engineering/) | 架构、DevOps、安全、数据库、测试、设计模式 | 82 |
| [产品](./domains/product/) | 敏捷、用户研究、增长、分析、战略 | 39 |
| [自然语言](./domains/natural-language/) | LLM、提示工程、AI Agent、模型训练 | 31 |
...
- [x] Phase 1: 基础结构 + 首批术语 (152 个术语)
- [x] Phase 2: CLI 翻译工具 (整句翻译 + 跨领域匹配)
